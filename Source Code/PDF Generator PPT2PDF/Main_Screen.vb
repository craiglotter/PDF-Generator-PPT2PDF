        ...
        Try
            ...
            If My.Computer.FileSystem.FileExists(TextBox1.Text) = True Then
                ...
                If My.Computer.FileSystem.FileExists(TextBox2.Text) = False Then
                    ...
                    Try
                        Dim wdo As Microsoft.Office.Interop.PowerPoint.Application = New Microsoft.Office.Interop.PowerPoint.Application
                        Dim wdoc As Microsoft.Office.Interop.PowerPoint.Presentation
                        wdoc = wdo.Presentations.Open(TextBox1.Text, Microsoft.Office.Core.MsoTriState.msoTrue, Microsoft.Office.Core.MsoTriState.msoFalse, Microsoft.Office.Core.MsoTriState.msoFalse)
                        wdoc.SaveAs(TextBox2.Text, Microsoft.Office.Interop.PowerPoint.PpSaveAsFileType.ppSaveAsPDF, Microsoft.Office.Core.MsoTriState.msoTrue)
                        wdoc.Close()
                        wdo.Quit()
                        wdo = Nothing
                        wdoc = Nothing
                    ...
                    Catch ex As Exception
                        Try
                            ...
                            ''NOTE''
                            'This code is untested and in all likelihood will fail to convert a xls document
                            Dim wdo As Microsoft.Office.Interop.PowerPoint.Application = New Microsoft.Office.Interop.PowerPoint.Application
                            Dim wdoc As Microsoft.Office.Interop.PowerPoint.DocumentWindow
                            Dim wdocs As Microsoft.Office.Interop.PowerPoint.DocumentWindows
                            ...
                            wdoc.Presentation.PrintOptions.ActivePrinter = "Acrobat Distiller"
                            wdoc = wdocs.Open(TextBox1.Text)
                            wdo.ActiveDocument.PrintOut(False, , , TextBox2.Text & ".ps")
                            wdoc.Close()
                            wdo.Presentation.PrintOptions.ActivePrinter = sPrevPrinter
                            wdo.Quit()
                            wdo = Nothing
